...
export class ModalAddMaterial implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<ModalAddMaterial>,
    ...
    onSendClick(): void {
        console.log(this.item)
        this.materialService.postMaterial(this.item).subscribe({
            next: data => {
                console.log(data)
                this.dialogRef.close();
    ...
    postTask(item: any) {
        console.log(this.item)
        this.materialService.postTask(item).subscribe({
            next: data => {
                console.log(data)
                // this.item.list = data || [];
            },
    ...
    getColors() {
        this.materialService.getColors().subscribe({
            next: data => {
                console.log(data)
