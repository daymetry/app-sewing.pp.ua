...
export class StorageRecordItemsService {
    ...
    // Read
    getStorageItemId(item: any) {

        console.log(item)
        console.log(`${this.apiUrl}/storage`)
        return this.http.get(`${this.apiUrl}/storage-items/getById?id=${item}&storageid=${item}`, this.headers);
    }

    // Read
    delStorageItems(item: any) {

        console.log(item)
        return this.http.delete(`${this.apiUrl}/storage-items/${item}`, this.headers);
    }
