...
@Component({
  selector: 'app-storage-transfer',
  templateUrl: './storage-transfer.component.html',
  styleUrls: ['./storage-transfer.component.css']
})
export class StorageTransferComponent implements OnInit {
